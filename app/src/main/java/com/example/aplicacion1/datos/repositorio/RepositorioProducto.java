...
public class RepositorioProducto {
    ...
    public Call<RespuestaProducto> editarProducto(int idArticulo, SolicitudProducto solicitudProducto) {
        return apiProductos.editarProducto(idArticulo, solicitudProducto);
    }
}
