...
public class ProductRepository implements RepositorioCatalogo {
    ...
    public LiveData<List<Product>> getAllProducts() {
        ...
        apiService.getAllProducts().enqueue(
    ...
    public LiveData<List<Product>> getProductsByCategory(String category) {
        ...
        apiService.getProductsByCategory(category).enqueue(
                new Callback<List<Product>>() {
                ...
                new Callback<List<Product>>() {
                    ...
                    public void onResponse(
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            callback.onError(
                                    "Error al obtener productos. Código: "
                                            + response.code()
                            );
                        }
                    }
